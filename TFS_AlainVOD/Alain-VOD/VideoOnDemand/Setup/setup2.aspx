...
<asp:Content ID="ActiveDirectoryContent" ContentPlaceHolderID="VODContentPlaceHolder" runat="server">
    ...
    <div class="container">
        ...
        <div class="col-md-12 full-width">
            ...
            <div class="column1">
                <asp:Literal runat="server" ID="Literal8" Text="<%$ Resources:Setup, ADD_Hd_enter_AD_Details%>" /></div>
            <!--Step1-->
            <div class="column2">
                <label>
            ...
            <div class="bottom-container clearfix">
                ...
                <p class="pull-right">
                    ...
                    <label runat="server" id="lblClickButton" for="btnNext" class="labelButton">
                        <asp:Literal runat="server" ID="Literal16" Text="<%$ Resources:Setup, ADD_Fot_btnNext%>" /><span class="sprite ic-arrow"></span></label>
                </p>
            </div>
        </div>
    </div>
