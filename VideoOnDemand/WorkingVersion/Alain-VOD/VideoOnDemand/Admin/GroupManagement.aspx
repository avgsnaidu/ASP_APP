...
<asp:Content ID="Content1" ContentPlaceHolderID="VODMangContentPlaceHolder" runat="server">
    ...
    <div id="management-bottom" class="col-md-12">
        <div class="block1 clearfix">
            <%--<h2 class="col-md-4"> <asp:Literal runat="server" Text="<%$ Resources:GroupManage, hdrGroupManagement %>" /></h2>--%>
            <div class="col-md-12">
                <ul>
                    <li>
                        <asp:LinkButton ID="lnkCreateGroup" runat="server" data-toggle="modal" data-target="#myModal2">
                        ...
                        </asp:LinkButton></li></ul><div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dlg-top">
                        <div class="modal-content">
                                        ...
                                        <div class="form-horizontal" role="form">
                                            <div class="form-group">
                                                <label for="txtGroupName" class="col-sm-4 control-label">
                                                    <asp:Literal ID="ltlMCG_groupName" runat="server" Text="<%$ Resources:GroupManage, MLCG_GroupName %>" /><span class="required"> *</span></label> <div class="col-sm-7">
                                                    <asp:TextBox type="text" runat="server" class="form-control textboxFormat required " ID="txtGroupName" placeholder="<%$ Resources:GroupManage, mdl2_gn_PlaceHolder %>" data-placement="top" data-trigger="manual" data-content="Must be at least 3 characters long, and must only contain letters." />
                                                      <asp:RequiredFieldValidator runat="server" ID="rfvGroupname" ControlToValidate="txtGroupName" ValidationGroup="Group" ErrorMessage="Group Name Required " ForeColor="#E2351D" Display="Dynamic"></asp:RequiredFieldValidator></div></div><div class="form-group">
                                                <label for="txtDescription" class="col-sm-4 control-label">
                                                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:GroupManage, mdl2_Description%>" /><span class="required"> *</span></label> <div class="col-sm-7">
                                                    <asp:TextBox runat="server" ID="txtDescription" class="form-control NoEmpty" name="" placeholder="<%$ Resources:GroupManage, mdl2_Desc_PlaceHolder%> " TextMode="MultiLine" data-placement="bottom" data-trigger="manual" data-content="Fields must not be empty."></asp:TextBox><asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtDescription" ValidationGroup="Group" ErrorMessage="Description Required " ForeColor="#E2351D" Display="Dynamic"></asp:RequiredFieldValidator></div></div></div></div></ContentTemplate><Triggers>
                            ...
                            <div class="modal-footer">
                                ...
                                </asp:Label><asp:Button ID="btnSave" runat="server" class="btn btn-primary" Text="<%$ Resources:GroupManage, btnSave_button%>" OnClick="btnSave_Click" ValidationGroup="Group" />
                        ...
                        <div class="modal-content">
                                        ...
                                        <div class="form-horizontal" role="form">
                                            <div class="form-group">
                                                <asp:Label runat="server" ID="lblgroupNText" for="txtEditGroupName" class="col-sm-4 control-label">
                                                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:GroupManage, UPMDL_GroupName_Text %>" /><span class="required"> *</span></asp:Label><div class="col-sm-7">
                                                    <asp:TextBox type="text" runat="server" class="form-control textboxFormat required " ID="txtEditGroupName" placeholder="<%$ Resources:GroupManage, UPMDL_GroupName_placeHolder %>" data-placement="top" data-trigger="manual" data-content="Must be at least 3 characters long, and must only contain letters." />
                                                      <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtEditGroupName" ValidationGroup="EditGroup" ErrorMessage="Group Name Required " ForeColor="#E2351D" Display="Dynamic"></asp:RequiredFieldValidator></div></div>
                                            <div class="form-group">
                                                <label for="inputPassword3" class="col-sm-4 control-label">
                                                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:GroupManage, UPMDL_txtEditDescription_text %>" />
                                                    <span class="required">*</span></label> <div class="col-sm-7">
                                                    <asp:TextBox runat="server" ID="txtEditDescription" class="form-control NoEmpty" name="" placeholder="<%$ Resources:GroupManage, UPMDL_txtEditDescription_PHold %>" TextMode="MultiLine" data-placement="bottom" data-trigger="manual" data-content="Fields must not be empty."></asp:TextBox><asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="txtEditDescription" ValidationGroup="EditGroup" ErrorMessage="Description  Required " ForeColor="#E2351D" Display="Dynamic"></asp:RequiredFieldValidator></div></div></div></div>
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:Label ID="Label2" runat="server" CssClass="mdlFooterMessage">
                                    <span class="required">*</span>
                                    <asp:Literal runat="server" ID="Literal8" Text="<%$ Resources:Setup, VOD_Fot_IndicatesMadatory%>" />
                                </asp:Label><asp:Button ID="btnSaveEdit" runat="server" class="btn btn-primary" Text="<%$ Resources:GroupManage, UPMDL_btnSaveEdit_button %>" OnClick="btnSaveEdit_Click" />
                                <%--<asp:LinkButton ID="btnSave" runat="server" class="btn btn-primary submit-link" Text="Save" />--%>
                                <%--<asp:ImageButton ID="btnSave" runat="server" UseSubmitBehavior="true" class="btn btn-primary" Text="Save" />--%>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                <ContentTemplate>
                                    <div class="modal-body">
                                        <div class="form-horizontal" role="form">
                                            <div class="form-group">
                                                <asp:Label runat="server" ID="lbldeleteWrng" class="col-sm- control-label" Style="width: 320px;"> </asp:Label></div></div></div></ContentTemplate><Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="gvGroupManagement" EventName="RowCommand" />
                                    ...
                                    <div class="modal-body">
                                        <div class="form-horizontal" role="form">
                                            <div class="form-group">
                                                ...
                                                <asp:Label ID="lblMessage" runat="server" class="col-sm- control-label alertBodyContentAlign padLR10" ></asp:Label></div></div></div></ContentTemplate><Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="gvGroupManagement" EventName="RowCommand" />
            ...
            <asp:UpdatePanel ID="UpdatePanelGroupMang" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="gvGroupManagement" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ...
                        OnRowEditing="gvGroupManagement_RowEditing" ShowHeaderWhenEmpty="true" OnLoad="GridView_Load" OnRowCreated="GridView_RowCreated" DataSourceID="GroupObjectSource"
                    ...
                    <asp:ObjectDataSource runat="server" ID="GroupObjectSource" SelectMethod="BindGroupsDetailsData"></asp:ObjectDataSource>
        ...
        <div id="deleteModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="delModalLabel" aria-hidden="true">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button><h3 id="delModalLabel">
                    <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:GroupManage, delModalLabel_h3 %>" /></h3>
            </div>
            <%-- <asp:UpdatePanel ID="upDel" runat="server">
                <ContentTemplate>--%>
            <div class="modal-body">
                Are you sure you want to delete the record? <asp:HiddenField ID="hfCode" runat="server" />
            </div>
            <div class="modal-footer">
                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-info" />
                <button class="btn btn-info" data-dismiss="modal" aria-hidden="true">Cancel</button></div><%--                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="btnDelete" EventName="Click" />
                </Triggers>
            </asp:UpdatePanel>--%></div></div></asp:Content>