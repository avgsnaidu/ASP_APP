<%@ Page Title="" Language="C#" MasterPageFile="~/VODManagement.master" AutoEventWireup="true" CodeBehind="District.aspx.cs" Inherits="VideoOnDemand.District" %>
        ...
        <div class="table-block clearfix col-md-12">
            <asp:GridView ID="gvDistrict" runat="server" AutoGenerateColumns="False" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="NAME_ENG" HeaderText="<%$ Resources:District, gvDist_Hd_DistName %> " ItemStyle-Width="35%" />
